...
const HeroComponent = () => {
  return (
    <section className="bg-primary relative flex flex-col md:flex-row items-center px-10 py-10 overflow-hidden" id="home">
      <div className="flex-1 text-center md:text-left space-y-5 md:w-1/2" data-aos="fade-right " data-aos-duration="1300">
      ...
      <div className="flex justify-center mt-10 md:mt-0 md:w-1/2" data-aos="fade-left" data-aos-duration="1300">
